      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Here You Go !!!</h1>
            <p>Choose the car that matches your personality. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Recently Added <span>CarForYou</span></h2>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Freshly Added</a></li>
        </ul>
      </div>
        ...
        <div class="testimonial-m">
          ...
          <div class="testimonial-content">
            <div class="testimonial-heading">
              <h5>Debapriyam Chaudhuri</h5>
            <p>Very good. All types of car available here very cheaper rate compare to other self drive car company</p>
          </div>
        </div>
        </div>
        <div class="testimonial-m">
