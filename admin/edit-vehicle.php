...
<div class="form-group">
<?php echo htmlentities($results->FuelType);?>
...
<select class="selectpicker" name="fueltype">
	<option value="<?php echo htmlentities($result->FuelType);?>" class="form-control" required><?php echo htmlentities($result->FuelType);?></option>
...
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>" style="border:solid 2px #000">Change Image 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>" style="border:solid 2px #000">Change Image 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>" style="border:solid 2px #000">Change Image 3</a>
</div>
</div>
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>" style="border:solid 2px #000">Change Image 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>" style="border:solid 2px #000">Change Image 5</a>
<?php } ?>
</div>
